...
namespace NHapiTools.Model.V25.Message
{
    /// <summary>
    ...
    public static class MessageExtensions
    {
        ...
        /// <summary>
        /// Get SFT Records from RDR_RDR
        /// </summary>
        public static IEnumerable GetSFTRecords(this RDR_RDR message)
        {
            object[] result = message.GetRecords("SFTRepetitionsUsed", "GetSFT");
        ...
        /// <summary>
        /// Get all SFT Records from RDR_RDR
        /// </summary>
        public static List<SFT> GetAllSFTRecords(this RDR_RDR message)
        {
            return message.GetAllRecords<SFT>("SFTRepetitionsUsed", "GetSFT");
        }

        /// <summary>
        /// Add a new RDR_RDR to SFT
        /// </summary>
        public static SFT AddSFT(this RDR_RDR message)
        {
            return message.GetSFT(message.SFTRepetitionsUsed);
        }
        ...
        /// <summary>
        /// Get QUERY_RESPONSE Records from RSP_K21
        /// </summary>
        public static IEnumerable GetQUERY_RESPONSERecords(this RSP_K21 message)
        {
            object[] result = message.GetRecords("QUERY_RESPONSERepetitionsUsed", "GetQUERY_RESPONSE");
        ...
        /// <summary>
        /// Get all QUERY_RESPONSE Records from RSP_K21
        /// </summary>
        public static List<RSP_K21_QUERY_RESPONSE> GetAllQUERY_RESPONSERecords(this RSP_K21 message)
        {
            return message.GetAllRecords<RSP_K21_QUERY_RESPONSE>("QUERY_RESPONSERepetitionsUsed", "GetQUERY_RESPONSE");
        }

        /// <summary>
        /// Add a new RSP_K21 to QUERY_RESPONSE
        /// </summary>
        public static RSP_K21_QUERY_RESPONSE AddQUERY_RESPONSE(this RSP_K21 message)
        {
            return message.GetQUERY_RESPONSE(message.QUERY_RESPONSERepetitionsUsed);
        }
