...
namespace NHapiTools.Tests
{
    public class HL7InputStreamMessageStringEnumeratorTests
    {
        ...
        public HL7InputStreamMessageStringEnumeratorTests(ITestOutputHelper output)
        {
            Output = output;
        ...
        [Fact(DisplayName = "Reads Hl7 messages from all files in directory")]
